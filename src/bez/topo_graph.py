...
def visualize_subgraph(G, visu_i=0, visu_j=0, visu_radius=100000): 
    ...
    if isinstance(subgraph, nx.MultiGraph):
        ...
        nx.draw(subgraph, pos=pos, node_size=10, edge_color='gray', node_color='blue', with_labels=False)
...
def extract_topology_from_skeleton(skeleton_img):
    ...
    topological_graph = nx.MultiGraph()  # Graphe topologique, V = intersections et feuilles, E = lignes de pixels
